				...
				<div class="o-grid">
					<div class="o-grid__cell">
						...
						<div class="o-card__desc">
							...
							<span class="t-sm-block t-lg-ml--md t-xs-ml--no t-xs-mt--md">
								<i class="far fa-calendar"></i>&nbsp;<?php echo JText::sprintf('COM_PP_SUBSCRIPTION_CREATED_TOOLTIP', $subscription->getSubscriptionDate(true)->format(JText::_('DATE_FORMAT_LC3')));?>
							</span>
							<?php } ?>
						</div>
					...
					<div class="o-grid__cell o-grid__cell--auto-size o-grid__cell--right">
						<?php if ($subscription->isExpired() && $subscription->getExpirationDate()) { ?>
							<?php echo '<span class="small">' . $this->html('subscription.status', $subscription) . '</span>'; ?>
						<?php } else { ?>
								...
								<div>
									...
									<?php if ($subscription->isActive()) { ?>
										<?php if ($subscription->expirationDate) { ?>
											...
											<b>
												<?php echo $subscription->getSubscriptionDate(true)->format(JText::_('DATE_FORMAT_LC4'));?>
											</b>

											<span class="separator t-lg-ml--md t-lg-mr--md">&mdash;</span>

											<b>
												<?php echo $subscription->getExpirationDate(true)->format(JText::_('DATE_FORMAT_LC4'));?>
											</b>
										<?php } else { ?>
				...
				<div class="o-grid">
					...
					<div class="o-grid__cell o-grid__cell--auto-size o-grid__cell--right" style="flex: auto;">
						<div class="o-btn-toolbar">
							...
							<?php if (($subscription->isRenewable()) && $subscription->isExpired()) { ?>
							<div style="margin: 0; padding: .6em 1.2em;">
