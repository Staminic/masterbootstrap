							...
							<?php if (!$customInvoiceContent) { ?>
								<div class="pp-invoice-menu__hd">
									...
									<table style="width:100%;">
										<tr>
											<td>
												<b><?php echo PP::rewriteContent($this->config->get('add_token'), $invoice, true); ?></b><br />
												<b><?php echo JText::sprintf('COM_PP_INVOICE_KEY', $invoice->getKey()); ?></b>
											</td>
											<td>
												&nbsp;
											</td>
											<td class="t-text--right">
												<table style="width:100%;">
													<tr>
														<td class="t-text--right">
															<b><?php echo PP::date($invoice->getCreatedDate(), true)->toDisplay(JText::_('DATE_FORMAT_LC3'));?></b>
														</td>
								...
								<table class="pp-invoice-table">
									<thead>
										<tr>
											<td>
												<b><?php echo JText::_('COM_PP_INVOICE_FROM');?></b><br />
									...
									<tbody>
										<tr>
											<td>
												<b><?php echo JText::_('COM_PAYPLANS_INVOICE_BILL_TO');?></b><br />
										...
										<tr>
											<td>
												<b><?php echo JText::_('COM_PP_DETAILS');?></b><br />

												<?php echo JText::_($invoice->getTitle()); ?><br />
												Année <?php echo PP::date($invoice->getCreatedDate(), true)->toDisplay(JText::_('Y'));?><br />
