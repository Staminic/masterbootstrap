...
(function($) {
	$(document).ready(function(){
		...
		// Add the link
		$('.navbar .navbar-header').append('<a id="panel-$moduleId-link" class="navbar-toggle panelnav-toggle hidden-sm hidden-md hidden-lg" href="#panel-$moduleId"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span><span class="title hidden">Menu</span></a>');
