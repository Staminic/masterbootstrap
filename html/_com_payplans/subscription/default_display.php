...
<?php elseif(is_array($subscription_records)):?>
		...
		<?php foreach($subscription_records as $record): ?>
			...
			<tr>
				...
				<td><?php echo PayplansHtml::link(XiRoute::_('index.php?option=com_payplans&view=subscription&task=display&subscription_key='.$subscription_key), $subscription->getTitle());?>
				<!-- </td><td> -->
